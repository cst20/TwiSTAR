...
class ScriptArguments:
    max_length: int = field(default=2048, metadata={"help": "Max sequence length for tokenization"})
...
if __name__ == "__main__":
    parser = HfArgumentParser((ModelArguments, DataArguments, ScriptArguments, TrainingArguments))
